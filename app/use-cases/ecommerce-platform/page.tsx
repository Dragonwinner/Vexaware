...
export const metadata: Metadata = {
  title: "E-commerce Platform Case Study - VEX Aware",
  description: "Learn how e-commerce platform improved security with VEX Aware.",
};
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "E-commerce Platform", url: "/use-cases/ecommerce-platform" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              How e-commerce platform transformed their vulnerability management with VEX Aware.
            </p>
          </header>
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <h2>Conclusion</h2>
            <p>
              By implementing VEX Aware, e-commerce platform achieved significant improvements 
