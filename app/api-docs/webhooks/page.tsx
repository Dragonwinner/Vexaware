...
export const metadata: Metadata = {
  title: "Webhooks API - VEX Aware API Documentation",
  description: "Complete API reference for webhooks api in VEX Aware.",
};

export default function ApiDocPage() {
  const exampleRequest = `curl -X GET "https://api.vexaware.com/v1/webhooks" \
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "Webhooks API", url: "/api-docs/webhooks" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Complete API reference and examples for webhooks api.
            </p>
          </header>
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <h2>Overview</h2>
            <p>
              The Webhooks API provides programmatic access to manage and query data 
