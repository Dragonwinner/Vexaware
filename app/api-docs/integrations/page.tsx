...
export const metadata: Metadata = {
  title: "Integrations API - VEX Aware API Documentation",
  description: "Complete API reference for integrations api in VEX Aware.",
};

export default function ApiDocPage() {
  const exampleRequest = `curl -X GET "https://api.vexaware.com/v1/integrations" \
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "Integrations API", url: "/api-docs/integrations" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Complete API reference and examples for integrations api.
            </p>
          </header>
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <h2>Overview</h2>
            <p>
              The Integrations API provides programmatic access to manage and query data 
            ...
            <h3>POST /integrations</h3>
            <p>Create a new resource.</p>

            <h3>GET /integrations/:id</h3>
            <p>Retrieve a specific resource by ID.</p>

            <h3>PUT /integrations/:id</h3>
            <p>Update an existing resource.</p>

            <h3>DELETE /integrations/:id</h3>
