      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "Vulnerabilities API", url: "/api-docs/vulnerabilities" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Complete API reference and examples for vulnerabilities api.
            </p>
          </header>
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <h2>Overview</h2>
            <p>
              The Vulnerabilities API provides programmatic access to manage and query data 
            ...
            <h3>POST /vulnerabilities</h3>
            <p>Create a new resource.</p>

            <h3>GET /vulnerabilities/:id</h3>
            <p>Retrieve a specific resource by ID.</p>

            <h3>PUT /vulnerabilities/:id</h3>
            <p>Update an existing resource.</p>

            <h3>DELETE /vulnerabilities/:id</h3>
