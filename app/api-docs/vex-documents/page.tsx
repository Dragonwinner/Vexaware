...
export const metadata: Metadata = {
  title: "VEX Documents API - VEX Aware API Documentation",
  description: "Complete API reference for vex documents api in VEX Aware.",
};

export default function ApiDocPage() {
  const exampleRequest = `curl -X GET "https://api.vexaware.com/v1/vex-documents" \
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "VEX Documents API", url: "/api-docs/vex-documents" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Complete API reference and examples for vex documents api.
            </p>
          </header>
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <h2>Overview</h2>
            <p>
              The VEX Documents API provides programmatic access to manage and query data 
            ...
            <h3>POST /vex-documents</h3>
            <p>Create a new resource.</p>

            <h3>GET /vex-documents/:id</h3>
            <p>Retrieve a specific resource by ID.</p>

            <h3>PUT /vex-documents/:id</h3>
            <p>Update an existing resource.</p>

            <h3>DELETE /vex-documents/:id</h3>
