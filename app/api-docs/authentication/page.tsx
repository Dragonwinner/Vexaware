...
export const metadata: Metadata = {
  title: "Authentication & Authorization - VEX Aware API Documentation",
  description: "Complete API reference for authentication & authorization in VEX Aware.",
};

export default function ApiDocPage() {
  const exampleRequest = `curl -X GET "https://api.vexaware.com/v1/authentication" \
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "Authentication & Authorization", url: "/api-docs/authentication" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Complete API reference and examples for authentication & authorization.
            </p>
          </header>
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <h2>Overview</h2>
            <p>
              The Authentication & Authorization provides programmatic access to manage and query data 
            ...
            <h3>GET /authentication/:id</h3>
            <p>Retrieve a specific resource by ID.</p>

            <h3>PUT /authentication/:id</h3>
            <p>Update an existing resource.</p>

            <h3>DELETE /authentication/:id</h3>
