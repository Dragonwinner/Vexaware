...
export const metadata: Metadata = {
  title: "SBOM Integration: Complete Guide - VEX Aware Blog",
  description: "Learn about sbom integration: complete guide and how it impacts vulnerability management.",
};
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            { name: "Blog", url: "/blog" },
            { name: "SBOM Integration: Complete Guide", url: "/blog/sbom-integration-guide" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4">
              SBOM Integration: Complete Guide
            </h1>
            ...
            <SocialShare title="SBOM Integration: Complete Guide" url="/blog/sbom-integration-guide" />
          </header>

          <div className="prose prose-lg dark:prose-invert max-w-none">
            <p className="lead">
              This article explores sbom integration: complete guide and provides practical insights for 
            ...
            <p>
              ...
              management is crucial. This article dives deep into sbom integration: complete guide and 
            ...
            <p>
              The impact of sbom integration: complete guide cannot be overstated. Organizations across 
            ...
            <h2>Conclusion</h2>
            <p>
              SBOM Integration: Complete Guide is a critical consideration for modern software teams. By following 
