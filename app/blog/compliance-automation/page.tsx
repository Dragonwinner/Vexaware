...
export const metadata: Metadata = {
  title: "Automating Security Compliance - VEX Aware Blog",
  description: "Learn about automating security compliance and how it impacts vulnerability management.",
};
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            { name: "Blog", url: "/blog" },
            { name: "Automating Security Compliance", url: "/blog/compliance-automation" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <SocialShare title="Automating Security Compliance" url="/blog/compliance-automation" />
          </header>

          <div className="prose prose-lg dark:prose-invert max-w-none">
            <p className="lead">
              This article explores automating security compliance and provides practical insights for 
            ...
            <p>
              ...
              management is crucial. This article dives deep into automating security compliance and 
            ...
            <p>
              The impact of automating security compliance cannot be overstated. Organizations across 
            ...
            <h2>Conclusion</h2>
            <p>
              Automating Security Compliance is a critical consideration for modern software teams. By following 
