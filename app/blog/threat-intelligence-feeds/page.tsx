...
export const metadata: Metadata = {
  title: "Integrating Threat Intelligence Feeds - VEX Aware Blog",
  description: "Learn about integrating threat intelligence feeds and how it impacts vulnerability management.",
};
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            { name: "Blog", url: "/blog" },
            { name: "Integrating Threat Intelligence Feeds", url: "/blog/threat-intelligence-feeds" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <SocialShare title="Integrating Threat Intelligence Feeds" url="/blog/threat-intelligence-feeds" />
          </header>

          <div className="prose prose-lg dark:prose-invert max-w-none">
            <p className="lead">
              This article explores integrating threat intelligence feeds and provides practical insights for 
            ...
            <p>
              ...
              management is crucial. This article dives deep into integrating threat intelligence feeds and 
            ...
            <p>
              The impact of integrating threat intelligence feeds cannot be overstated. Organizations across 
            ...
            <h2>Conclusion</h2>
            <p>
              Integrating Threat Intelligence Feeds is a critical consideration for modern software teams. By following 
