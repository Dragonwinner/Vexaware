...
export const metadata: Metadata = {
  title: "Understanding the VEX Standard - VEX Aware Blog",
  description: "Learn about understanding the vex standard and how it impacts vulnerability management.",
};
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            { name: "Blog", url: "/blog" },
            { name: "Understanding the VEX Standard", url: "/blog/understanding-vex-standard" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4">
              Understanding the VEX Standard
            </h1>
            ...
            <SocialShare title="Understanding the VEX Standard" url="/blog/understanding-vex-standard" />
          </header>

          <div className="prose prose-lg dark:prose-invert max-w-none">
            <p className="lead">
              This article explores understanding the vex standard and provides practical insights for 
            ...
            <p>
              ...
              management is crucial. This article dives deep into understanding the vex standard and 
            ...
            <p>
              The impact of understanding the vex standard cannot be overstated. Organizations across 
            ...
            <h2>Conclusion</h2>
            <p>
              Understanding the VEX Standard is a critical consideration for modern software teams. By following 
