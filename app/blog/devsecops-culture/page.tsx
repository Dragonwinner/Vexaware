...
export const metadata: Metadata = {
  title: "Building a DevSecOps Culture - VEX Aware Blog",
  description: "Learn about building a devsecops culture and how it impacts vulnerability management.",
};
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            { name: "Blog", url: "/blog" },
            { name: "Building a DevSecOps Culture", url: "/blog/devsecops-culture" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <SocialShare title="Building a DevSecOps Culture" url="/blog/devsecops-culture" />
          </header>

          <div className="prose prose-lg dark:prose-invert max-w-none">
            <p className="lead">
              This article explores building a devsecops culture and provides practical insights for 
            ...
            <p>
              ...
              management is crucial. This article dives deep into building a devsecops culture and 
            ...
            <p>
              The impact of building a devsecops culture cannot be overstated. Organizations across 
            ...
            <h2>Conclusion</h2>
            <p>
              Building a DevSecOps Culture is a critical consideration for modern software teams. By following 
