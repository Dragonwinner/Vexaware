...
export const metadata: Metadata = {
  title: "Supply Chain Attacks in 2024: Lessons Learned - VEX Aware Blog",
  description: "Learn about supply chain attacks in 2024: lessons learned and how it impacts vulnerability management.",
};
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            { name: "Blog", url: "/blog" },
            { name: "Supply Chain Attacks in 2024: Lessons Learned", url: "/blog/supply-chain-attacks-2024" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4">
              Supply Chain Attacks in 2024: Lessons Learned
            </h1>
            ...
            <SocialShare title="Supply Chain Attacks in 2024: Lessons Learned" url="/blog/supply-chain-attacks-2024" />
          </header>

          <div className="prose prose-lg dark:prose-invert max-w-none">
            <p className="lead">
              This article explores supply chain attacks in 2024: lessons learned and provides practical insights for 
            ...
            <p>
              ...
              management is crucial. This article dives deep into supply chain attacks in 2024: lessons learned and 
            ...
            <p>
              The impact of supply chain attacks in 2024: lessons learned cannot be overstated. Organizations across 
            ...
            <h2>Conclusion</h2>
            <p>
              Supply Chain Attacks in 2024: Lessons Learned is a critical consideration for modern software teams. By following 
