...
export const metadata: Metadata = {
  title: "Kubernetes Security Best Practices - VEX Aware Blog",
  description: "Learn about kubernetes security best practices and how it impacts vulnerability management.",
};
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            { name: "Blog", url: "/blog" },
            { name: "Kubernetes Security Best Practices", url: "/blog/kubernetes-security-best-practices" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <SocialShare title="Kubernetes Security Best Practices" url="/blog/kubernetes-security-best-practices" />
          </header>

          <div className="prose prose-lg dark:prose-invert max-w-none">
            <p className="lead">
              This article explores kubernetes security best practices and provides practical insights for 
            ...
            <p>
              ...
              management is crucial. This article dives deep into kubernetes security best practices and 
            ...
            <p>
              The impact of kubernetes security best practices cannot be overstated. Organizations across 
            ...
            <h2>Conclusion</h2>
            <p>
              Kubernetes Security Best Practices is a critical consideration for modern software teams. By following 
