...
export const metadata: Metadata = {
  title: "The False Positive Problem in Vulnerability Scanning - VEX Aware Blog",
  description: "Learn about the false positive problem in vulnerability scanning and how it impacts vulnerability management.",
};
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            { name: "Blog", url: "/blog" },
            { name: "The False Positive Problem in Vulnerability Scanning", url: "/blog/false-positive-problem" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4">
              The False Positive Problem in Vulnerability Scanning
            </h1>
            ...
            <SocialShare title="The False Positive Problem in Vulnerability Scanning" url="/blog/false-positive-problem" />
          </header>

          <div className="prose prose-lg dark:prose-invert max-w-none">
            <p className="lead">
              This article explores the false positive problem in vulnerability scanning and provides practical insights for 
            ...
            <p>
              ...
              management is crucial. This article dives deep into the false positive problem in vulnerability scanning and 
            ...
            <p>
              The impact of the false positive problem in vulnerability scanning cannot be overstated. Organizations across 
            ...
            <h2>Conclusion</h2>
            <p>
              The False Positive Problem in Vulnerability Scanning is a critical consideration for modern software teams. By following 
