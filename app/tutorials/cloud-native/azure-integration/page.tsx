...
export const metadata: Metadata = {
  title: "Azure AKS Security - VEX Aware Tutorial",
  description: "Security best practices for Azure Kubernetes Service",
  keywords: ["azure","aks","kubernetes","security"],
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "Azure AKS Security", url: "/tutorials/cloud-native/azure-integration" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <SocialShare 
              ...
              url="/tutorials/cloud-native/azure-integration"
            />
          </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 prose prose-lg dark:prose-invert max-w-none">
              <section id="introduction">
                <h2>Introduction</h2>
                <p>
                  This tutorial will guide you through azure aks security. 
              ...
              <section id="overview">
                <h2>Overview</h2>
                <p>
                  Security best practices for Azure Kubernetes Service This section provides a high-level overview of the topic 
