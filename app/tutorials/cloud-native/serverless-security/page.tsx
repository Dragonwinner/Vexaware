...
export const metadata: Metadata = {
  title: "Serverless Security - VEX Aware Tutorial",
  description: "Managing vulnerabilities in serverless applications (Lambda, Cloud Functions)",
  keywords: ["serverless","lambda","functions","security"],
};
    ...
    "email": "security@example.com"
              ...
              <section id="next-steps">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
                  <Link href="/tutorials/cloud-native" className="p-4 border-2 border-gray-200 dark:border-gray-800 rounded-lg hover:border-blue-600 dark:hover:border-blue-400 transition-all">
