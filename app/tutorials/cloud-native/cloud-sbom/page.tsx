...
export const metadata: Metadata = {
  title: "Cloud SBOM Management - VEX Aware Tutorial",
  description: "Learn cloud sbom management with VEX Aware.",
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "Cloud SBOM Management", url: "/tutorials/cloud-native/cloud-sbom" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4">
              Cloud SBOM Management
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Complete guide to cloud sbom management in VEX Aware.
            </p>
            <SocialShare 
              title="Cloud SBOM Management"
              url="/tutorials/cloud-native/cloud-sbom"
            />
          </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 prose prose-lg dark:prose-invert max-w-none">
              <section id="introduction">
                <h2>Introduction</h2>
                <p>
                  This comprehensive guide covers cloud sbom management. You'll learn 
