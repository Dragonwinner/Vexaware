...
export const metadata: Metadata = {
  title: "Infrastructure as Code Security - VEX Aware Tutorial",
  description: "Learn infrastructure as code security with VEX Aware.",
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "Infrastructure as Code Security", url: "/tutorials/cloud-native/iac-security" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Complete guide to infrastructure as code security in VEX Aware.
            </p>
            <SocialShare 
              title="Infrastructure as Code Security"
              url="/tutorials/cloud-native/iac-security"
            />
          </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 prose prose-lg dark:prose-invert max-w-none">
              <section id="introduction">
                <h2>Introduction</h2>
                <p>
                  This comprehensive guide covers infrastructure as code security. You'll learn 
