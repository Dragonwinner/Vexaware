...
export const metadata: Metadata = {
  title: "AWS ECS/EKS Integration - VEX Aware Tutorial",
  description: "Integrating VEX Aware with AWS container services",
  keywords: ["aws","ecs","eks","cloud"],
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "AWS ECS/EKS Integration", url: "/tutorials/cloud-native/aws-integration" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Integrating VEX Aware with AWS container services
            </p>
            <SocialShare 
              title="AWS ECS/EKS Integration"
              url="/tutorials/cloud-native/aws-integration"
            />
          </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 prose prose-lg dark:prose-invert max-w-none">
              <section id="introduction">
                <h2>Introduction</h2>
                <p>
                  This tutorial will guide you through aws ecs/eks integration. 
              ...
              <section id="overview">
                <h2>Overview</h2>
                <p>
                  Integrating VEX Aware with AWS container services This section provides a high-level overview of the topic 
