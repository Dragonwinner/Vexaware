...
export const metadata: Metadata = {
  title: "Pod Security Policies - VEX Aware Tutorial",
  description: "Learn pod security policies with VEX Aware.",
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "Pod Security Policies", url: "/tutorials/kubernetes-containers/pod-security-policies" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Complete guide to pod security policies in VEX Aware.
            </p>
            <SocialShare 
              title="Pod Security Policies"
              url="/tutorials/kubernetes-containers/pod-security-policies"
            />
          </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 prose prose-lg dark:prose-invert max-w-none">
              <section id="introduction">
                <h2>Introduction</h2>
                <p>
                  This comprehensive guide covers pod security policies. You'll learn 
