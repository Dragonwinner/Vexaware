...
export const metadata: Metadata = {
  title: "Container Image Scanning - VEX Aware Tutorial",
  description: "Scanning container images for vulnerabilities with Trivy, Grype, and other tools",
  keywords: ["scanning","vulnerabilities","trivy","images"],
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "Container Image Scanning", url: "/tutorials/kubernetes-containers/image-scanning" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Scanning container images for vulnerabilities with Trivy, Grype, and other tools
            </p>
            <SocialShare 
              title="Container Image Scanning"
              url="/tutorials/kubernetes-containers/image-scanning"
            />
          </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 prose prose-lg dark:prose-invert max-w-none">
              <section id="introduction">
                <h2>Introduction</h2>
                <p>
                  This tutorial will guide you through container image scanning. 
              ...
              <section id="overview">
                <h2>Overview</h2>
                <p>
                  Scanning container images for vulnerabilities with Trivy, Grype, and other tools This section provides a high-level overview of the topic 
