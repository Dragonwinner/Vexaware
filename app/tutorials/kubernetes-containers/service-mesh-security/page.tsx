...
export const metadata: Metadata = {
  title: "Service Mesh Security - VEX Aware Tutorial",
  description: "Learn service mesh security with VEX Aware.",
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "Service Mesh Security", url: "/tutorials/kubernetes-containers/service-mesh-security" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Complete guide to service mesh security in VEX Aware.
            </p>
            <SocialShare 
              title="Service Mesh Security"
              url="/tutorials/kubernetes-containers/service-mesh-security"
            />
          </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 prose prose-lg dark:prose-invert max-w-none">
              <section id="introduction">
                <h2>Introduction</h2>
                <p>
                  This comprehensive guide covers service mesh security. You'll learn 
