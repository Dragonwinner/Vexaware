...
export const metadata: Metadata = {
  title: "Container Registry Integration - VEX Aware Tutorial",
  description: "Learn container registry integration with VEX Aware.",
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "Container Registry Integration", url: "/tutorials/kubernetes-containers/registry-integration" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Complete guide to container registry integration in VEX Aware.
            </p>
            <SocialShare 
              title="Container Registry Integration"
              url="/tutorials/kubernetes-containers/registry-integration"
            />
          </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 prose prose-lg dark:prose-invert max-w-none">
              <section id="introduction">
                <h2>Introduction</h2>
                <p>
                  This comprehensive guide covers container registry integration. You'll learn 
...
vexaware kubernetes-containers init

# Verify installation
vexaware kubernetes-containers status`}
                  language="bash" 
                />
