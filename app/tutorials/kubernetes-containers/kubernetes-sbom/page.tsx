...
export const metadata: Metadata = {
  title: "Kubernetes SBOM Integration - VEX Aware Tutorial",
  description: "Generating and managing SBOMs for Kubernetes workloads",
  keywords: ["sbom","kubernetes","supply chain"],
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "Kubernetes SBOM Integration", url: "/tutorials/kubernetes-containers/kubernetes-sbom" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Generating and managing SBOMs for Kubernetes workloads
            </p>
            <SocialShare 
              title="Kubernetes SBOM Integration"
              url="/tutorials/kubernetes-containers/kubernetes-sbom"
            />
          </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 prose prose-lg dark:prose-invert max-w-none">
              <section id="introduction">
                <h2>Introduction</h2>
                <p>
                  This tutorial will guide you through kubernetes sbom integration. 
              ...
              <section id="overview">
                <h2>Overview</h2>
                <p>
                  Generating and managing SBOMs for Kubernetes workloads This section provides a high-level overview of the topic 
