...
export const metadata: Metadata = {
  title: "Container Security Fundamentals - VEX Aware Tutorial",
  description: "Essential concepts for securing Docker containers and Kubernetes pods",
  keywords: ["containers","security","docker","kubernetes"],
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "Container Security Fundamentals", url: "/tutorials/kubernetes-containers/container-security-basics" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Essential concepts for securing Docker containers and Kubernetes pods
            </p>
            <SocialShare 
              title="Container Security Fundamentals"
              url="/tutorials/kubernetes-containers/container-security-basics"
            />
          </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 prose prose-lg dark:prose-invert max-w-none">
              <section id="introduction">
                <h2>Introduction</h2>
                <p>
                  This tutorial will guide you through container security fundamentals. 
              ...
              <section id="overview">
                <h2>Overview</h2>
                <p>
                  Essential concepts for securing Docker containers and Kubernetes pods This section provides a high-level overview of the topic 
    ...
    "email": "security@example.com"
              ...
              <section id="next-steps">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
                  <Link href="/tutorials/kubernetes-containers" className="p-4 border-2 border-gray-200 dark:border-gray-800 rounded-lg hover:border-blue-600 dark:hover:border-blue-400 transition-all">
