...
export const metadata: Metadata = {
  title: "Runtime Security Monitoring - VEX Aware Tutorial",
  description: "Detecting and preventing threats at runtime in containerized environments",
  keywords: ["runtime","monitoring","threats","detection"],
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "Runtime Security Monitoring", url: "/tutorials/kubernetes-containers/runtime-security" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Detecting and preventing threats at runtime in containerized environments
            </p>
            <SocialShare 
              title="Runtime Security Monitoring"
              url="/tutorials/kubernetes-containers/runtime-security"
            />
          </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 prose prose-lg dark:prose-invert max-w-none">
              <section id="introduction">
                <h2>Introduction</h2>
                <p>
                  This tutorial will guide you through runtime security monitoring. 
              ...
              <section id="overview">
                <h2>Overview</h2>
                <p>
                  Detecting and preventing threats at runtime in containerized environments This section provides a high-level overview of the topic 
