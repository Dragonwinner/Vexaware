      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "VEX Aware Dashboard Tour", url: "/tutorials/getting-started/dashboard-tour" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4">
              VEX Aware Dashboard Tour
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Navigate the VEX Aware dashboard and understand all key features and sections.
            </p>
            <SocialShare 
              title="VEX Aware Dashboard Tour"
              url="/tutorials/getting-started/dashboard-tour"
            />
          </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 prose prose-lg dark:prose-invert max-w-none">
              <section id="introduction">
                <h2>Introduction</h2>
                <p>
                  Navigate the VEX Aware dashboard and understand all key features and sections. This tutorial provides a comprehensive, easy-to-follow 
...
# ✓ All systems operational`}
          ...
          <TutorialNavigation
            ...
            nextArticle={{
              title: "Creating Your First VEX Document",
              href: "/tutorials/getting-started/first-vex-document",
              description: "Learn how to create and manage your first VEX document with practical examples."
            }}
          />
        </article>
      </div>
