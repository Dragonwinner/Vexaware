...
export const metadata: Metadata = {
  title: "Your First VEX Document in 10 Minutes - VEX Aware Tutorial",
  description: "Create and publish your first VEX document to communicate vulnerability status.",
};
