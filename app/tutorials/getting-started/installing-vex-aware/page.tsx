...
export const metadata: Metadata = {
  title: "Installing VEX Aware - Quick Start Guide - VEX Aware Tutorial",
  description: "Step-by-step guide to install and configure VEX Aware using Docker, Kubernetes, or bare metal.",
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "Installing VEX Aware - Quick Start Guide", url: "/tutorials/getting-started/installing-vex-aware" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4">
              Installing VEX Aware - Quick Start Guide
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Step-by-step guide to install and configure VEX Aware using Docker, Kubernetes, or bare metal.
            </p>
            <SocialShare 
              title="Installing VEX Aware - Quick Start Guide"
              url="/tutorials/getting-started/installing-vex-aware"
            />
          </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 prose prose-lg dark:prose-invert max-w-none">
              <section id="introduction">
                <h2>Introduction</h2>
                <p>
                  Step-by-step guide to install and configure VEX Aware using Docker, Kubernetes, or bare metal. This tutorial provides a comprehensive, easy-to-follow 
