      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "Troubleshooting Common Issues", url: "/tutorials/technical-implementation/troubleshooting" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Complete guide to troubleshooting common issues in VEX Aware.
            </p>
            <SocialShare 
              title="Troubleshooting Common Issues"
              url="/tutorials/technical-implementation/troubleshooting"
            />
          </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 prose prose-lg dark:prose-invert max-w-none">
              <section id="introduction">
                <h2>Introduction</h2>
                <p>
                  This comprehensive guide covers troubleshooting common issues. You'll learn 
...
vexaware technical-implementation init

# Verify installation
vexaware technical-implementation status`}
                  language="bash" 
                />
...
vexaware logs tail --lines 100`}
          ...
          <TutorialNavigation
            previousArticle={{
              ...
              href: "/tutorials/technical-implementation/backup-recovery",
              description: "Implement robust backup and disaster recovery strategies."
            }}
            nextArticle={{
              title: "Custom Policies",
              href: "/tutorials/technical-implementation/custom-policies",
              description: "Create and manage custom vulnerability assessment policies."
            }}
          />
        </article>
      </div>
