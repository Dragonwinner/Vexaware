...
export const metadata: Metadata = {
  title: "Configuration Management - VEX Aware Tutorial",
  description: "Managing configuration across environments using environment variables and config files",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "Configuration Management", url: "/tutorials/technical-implementation/configuration-management" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Managing configuration across environments using environment variables and config files
            </p>
            <SocialShare 
              title="Configuration Management"
              url="/tutorials/technical-implementation/configuration-management"
            />
          </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 prose prose-lg dark:prose-invert max-w-none">
              <section id="introduction">
                <h2>Introduction</h2>
                <p>
                  This tutorial will guide you through configuration management. 
              ...
              <section id="overview">
                <h2>Overview</h2>
                <p>
                  Managing configuration across environments using environment variables and config files This section provides a high-level overview of the topic 
