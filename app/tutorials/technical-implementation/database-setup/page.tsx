...
export const metadata: Metadata = {
  title: "Database Setup and Migration - VEX Aware Tutorial",
  description: "Setting up PostgreSQL, running migrations, and database best practices",
  keywords: ["database","postgresql","migrations","schema"],
};
