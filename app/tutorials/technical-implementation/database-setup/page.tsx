      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "Database Setup and Migration", url: "/tutorials/technical-implementation/database-setup" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Setting up PostgreSQL, running migrations, and database best practices
            </p>
            <SocialShare 
              title="Database Setup and Migration"
              url="/tutorials/technical-implementation/database-setup"
            />
          </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 prose prose-lg dark:prose-invert max-w-none">
              <section id="introduction">
                <h2>Introduction</h2>
                <p>
                  This tutorial will guide you through database setup and migration. 
              ...
              <section id="overview">
                <h2>Overview</h2>
                <p>
                  Setting up PostgreSQL, running migrations, and database best practices This section provides a high-level overview of the topic 
    ...
    "email": "security@example.com"
          ...
          <TutorialNavigation
            previousArticle={{
              ...
              description: "Deploy VEX Aware on Kubernetes with best practices."
            }}
            nextArticle={{
              title: "Authentication Setup",
              href: "/tutorials/technical-implementation/authentication-setup",
              description: "Configure authentication and authorization for VEX Aware."
            }}
          />
        </article>
      </div>
