...
export const metadata: Metadata = {
  title: "Kubernetes Deployment - VEX Aware Tutorial",
  description: "Deploy VEX Aware on Kubernetes with Helm charts and best practices",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "Kubernetes Deployment", url: "/tutorials/technical-implementation/kubernetes-deployment" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Deploy VEX Aware on Kubernetes with Helm charts and best practices
            </p>
            <SocialShare 
              title="Kubernetes Deployment"
              url="/tutorials/technical-implementation/kubernetes-deployment"
            />
          </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 prose prose-lg dark:prose-invert max-w-none">
              <section id="introduction">
                <h2>Introduction</h2>
                <p>
                  This tutorial will guide you through kubernetes deployment. 
              ...
              <section id="overview">
                <h2>Overview</h2>
                <p>
                  Deploy VEX Aware on Kubernetes with Helm charts and best practices This section provides a high-level overview of the topic 
