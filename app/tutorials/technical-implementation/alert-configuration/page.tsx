...
export const metadata: Metadata = {
  title: "Alert and Notification Configuration - VEX Aware Tutorial",
  description: "Learn alert and notification configuration with VEX Aware.",
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "Alert and Notification Configuration", url: "/tutorials/technical-implementation/alert-configuration" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Complete guide to alert and notification configuration in VEX Aware.
            </p>
            <SocialShare 
              title="Alert and Notification Configuration"
              url="/tutorials/technical-implementation/alert-configuration"
            />
          </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 prose prose-lg dark:prose-invert max-w-none">
              <section id="introduction">
                <h2>Introduction</h2>
                <p>
                  This comprehensive guide covers alert and notification configuration. You'll learn 
