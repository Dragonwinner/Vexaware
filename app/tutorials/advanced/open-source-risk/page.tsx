...
export const metadata: Metadata = {
  title: "Open Source Risk Management - VEX Aware Tutorial",
  description: "Learn open source risk management with VEX Aware.",
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "Open Source Risk Management", url: "/tutorials/advanced/open-source-risk" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Complete guide to open source risk management in VEX Aware.
            </p>
            <SocialShare 
              title="Open Source Risk Management"
              url="/tutorials/advanced/open-source-risk"
            />
          </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 prose prose-lg dark:prose-invert max-w-none">
              <section id="introduction">
                <h2>Introduction</h2>
                <p>
                  This comprehensive guide covers open source risk management. You'll learn 
