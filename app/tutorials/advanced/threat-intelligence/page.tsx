...
export const metadata: Metadata = {
  title: "Threat Intelligence Integration - VEX Aware Tutorial",
  description: "Integrating external threat intelligence feeds for enhanced protection",
  keywords: ["threat intelligence","feeds","integration","cti"],
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "Threat Intelligence Integration", url: "/tutorials/advanced/threat-intelligence" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Integrating external threat intelligence feeds for enhanced protection
            </p>
            <SocialShare 
              title="Threat Intelligence Integration"
              url="/tutorials/advanced/threat-intelligence"
            />
          </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 prose prose-lg dark:prose-invert max-w-none">
              <section id="introduction">
                <h2>Introduction</h2>
                <p>
                  This tutorial will guide you through threat intelligence integration. 
              ...
              <section id="overview">
                <h2>Overview</h2>
                <p>
                  Integrating external threat intelligence feeds for enhanced protection This section provides a high-level overview of the topic 
