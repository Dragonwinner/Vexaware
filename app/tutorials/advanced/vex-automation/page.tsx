...
export const metadata: Metadata = {
  title: "VEX Document Automation - VEX Aware Tutorial",
  description: "Learn vex document automation with VEX Aware.",
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "VEX Document Automation", url: "/tutorials/advanced/vex-automation" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Complete guide to vex document automation in VEX Aware.
            </p>
            <SocialShare 
              title="VEX Document Automation"
              url="/tutorials/advanced/vex-automation"
            />
          </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 prose prose-lg dark:prose-invert max-w-none">
              <section id="introduction">
                <h2>Introduction</h2>
                <p>
                  This comprehensive guide covers vex document automation. You'll learn 
