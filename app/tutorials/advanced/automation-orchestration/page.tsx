...
export const metadata: Metadata = {
  title: "Security Automation and Orchestration - VEX Aware Tutorial",
  description: "Automating security workflows with VEX Aware APIs",
  keywords: ["automation","orchestration","soar","workflows"],
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "Security Automation and Orchestration", url: "/tutorials/advanced/automation-orchestration" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Automating security workflows with VEX Aware APIs
            </p>
            <SocialShare 
              title="Security Automation and Orchestration"
              url="/tutorials/advanced/automation-orchestration"
            />
          </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 prose prose-lg dark:prose-invert max-w-none">
              <section id="introduction">
                <h2>Introduction</h2>
                <p>
                  This tutorial will guide you through security automation and orchestration. 
              ...
              <section id="overview">
                <h2>Overview</h2>
                <p>
                  Automating security workflows with VEX Aware APIs This section provides a high-level overview of the topic 
