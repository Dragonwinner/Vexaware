...
export const metadata: Metadata = {
  title: "Supply Chain Security - VEX Aware Tutorial",
  description: "Securing your software supply chain with VEX and SBOM",
  keywords: ["supply chain","sbom","dependencies","security"],
};
