...
export const metadata: Metadata = {
  title: "PCI DSS Requirements - VEX Aware Tutorial",
  description: "Achieving PCI DSS compliance with VEX Aware",
  keywords: ["pci","dss","compliance","payment"],
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "PCI DSS Requirements", url: "/tutorials/compliance/pci-dss" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Achieving PCI DSS compliance with VEX Aware
            </p>
            <SocialShare 
              title="PCI DSS Requirements"
              url="/tutorials/compliance/pci-dss"
            />
          </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 prose prose-lg dark:prose-invert max-w-none">
              <section id="introduction">
                <h2>Introduction</h2>
                <p>
                  This tutorial will guide you through pci dss requirements. 
              ...
              <section id="overview">
                <h2>Overview</h2>
                <p>
                  Achieving PCI DSS compliance with VEX Aware This section provides a high-level overview of the topic 
