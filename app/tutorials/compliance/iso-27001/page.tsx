...
export const metadata: Metadata = {
  title: "ISO 27001 Certification - VEX Aware Tutorial",
  description: "Leveraging VEX Aware for ISO 27001 information security management",
  keywords: ["iso","27001","certification","isms"],
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "ISO 27001 Certification", url: "/tutorials/compliance/iso-27001" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Leveraging VEX Aware for ISO 27001 information security management
            </p>
            <SocialShare 
              title="ISO 27001 Certification"
              url="/tutorials/compliance/iso-27001"
            />
          </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 prose prose-lg dark:prose-invert max-w-none">
              <section id="introduction">
                <h2>Introduction</h2>
                <p>
                  This tutorial will guide you through iso 27001 certification. 
              ...
              <section id="overview">
                <h2>Overview</h2>
                <p>
                  Leveraging VEX Aware for ISO 27001 information security management This section provides a high-level overview of the topic 
