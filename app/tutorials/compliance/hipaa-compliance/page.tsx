...
export const metadata: Metadata = {
  title: "HIPAA Compliance - VEX Aware Tutorial",
  description: "Healthcare security and HIPAA compliance with VEX Aware",
  keywords: ["hipaa","healthcare","compliance","security"],
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "HIPAA Compliance", url: "/tutorials/compliance/hipaa-compliance" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Healthcare security and HIPAA compliance with VEX Aware
            </p>
            <SocialShare 
              title="HIPAA Compliance"
              url="/tutorials/compliance/hipaa-compliance"
            />
          </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 prose prose-lg dark:prose-invert max-w-none">
              <section id="introduction">
                <h2>Introduction</h2>
                <p>
                  This tutorial will guide you through hipaa compliance. 
              ...
              <section id="overview">
                <h2>Overview</h2>
                <p>
                  Healthcare security and HIPAA compliance with VEX Aware This section provides a high-level overview of the topic 
