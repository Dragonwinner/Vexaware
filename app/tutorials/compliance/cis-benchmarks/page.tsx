...
export const metadata: Metadata = {
  title: "CIS Benchmarks Compliance - VEX Aware Tutorial",
  description: "Learn cis benchmarks compliance with VEX Aware.",
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "CIS Benchmarks Compliance", url: "/tutorials/compliance/cis-benchmarks" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Complete guide to cis benchmarks compliance in VEX Aware.
            </p>
            <SocialShare 
              title="CIS Benchmarks Compliance"
              url="/tutorials/compliance/cis-benchmarks"
            />
          </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 prose prose-lg dark:prose-invert max-w-none">
              <section id="introduction">
                <h2>Introduction</h2>
                <p>
                  This comprehensive guide covers cis benchmarks compliance. You'll learn 
