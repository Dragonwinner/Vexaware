      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "SOC 2 Compliance Guide", url: "/tutorials/compliance/soc2-compliance" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Using VEX Aware to meet SOC 2 security requirements
            </p>
            <SocialShare 
              title="SOC 2 Compliance Guide"
              url="/tutorials/compliance/soc2-compliance"
            />
          </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 prose prose-lg dark:prose-invert max-w-none">
              <section id="introduction">
                <h2>Introduction</h2>
                <p>
                  This tutorial will guide you through soc 2 compliance guide. 
              ...
              <section id="overview">
                <h2>Overview</h2>
                <p>
                  Using VEX Aware to meet SOC 2 security requirements This section provides a high-level overview of the topic 
