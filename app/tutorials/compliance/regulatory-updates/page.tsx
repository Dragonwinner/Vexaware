...
export const metadata: Metadata = {
  title: "Staying Current with Regulatory Updates - VEX Aware Tutorial",
  description: "Learn staying current with regulatory updates with VEX Aware.",
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "Staying Current with Regulatory Updates", url: "/tutorials/compliance/regulatory-updates" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Complete guide to staying current with regulatory updates in VEX Aware.
            </p>
            <SocialShare 
              title="Staying Current with Regulatory Updates"
              url="/tutorials/compliance/regulatory-updates"
            />
          </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 prose prose-lg dark:prose-invert max-w-none">
              <section id="introduction">
                <h2>Introduction</h2>
                <p>
                  This comprehensive guide covers staying current with regulatory updates. You'll learn 
...
vexaware compliance init

# Verify installation
vexaware compliance status`}
                  language="bash" 
                />
