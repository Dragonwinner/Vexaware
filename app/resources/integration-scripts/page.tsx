...
export const metadata: Metadata = {
  title: "Integration Scripts - VEX Aware Resources",
  description: "Download integration scripts and other resources for VEX Aware.",
};
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "Integration Scripts", url: "/resources/integration-scripts" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Ready-to-use integration scripts to accelerate your VEX Aware implementation.
            </p>
          </header>
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <h2>Overview</h2>
            <p>
              These integration scripts are designed to help you quickly implement 
