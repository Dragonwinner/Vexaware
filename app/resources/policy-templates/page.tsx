...
export const metadata: Metadata = {
  title: "Policy Templates - VEX Aware Resources",
  description: "Download policy templates and other resources for VEX Aware.",
};
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "Policy Templates", url: "/resources/policy-templates" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Ready-to-use policy templates to accelerate your VEX Aware implementation.
            </p>
          </header>
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <h2>Overview</h2>
            <p>
              These policy templates are designed to help you quickly implement 
