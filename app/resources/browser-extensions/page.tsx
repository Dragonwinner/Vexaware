...
export const metadata: Metadata = {
  title: "Browser Extensions - VEX Aware Resources",
  description: "Download browser extensions and other resources for VEX Aware.",
};
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Ready-to-use browser extensions to accelerate your VEX Aware implementation.
            </p>
          </header>
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <h2>Overview</h2>
            <p>
              These browser extensions are designed to help you quickly implement 
