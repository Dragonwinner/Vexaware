...
export const metadata: Metadata = {
  title: "Migration Tools - VEX Aware Resources",
  description: "Download migration tools and other resources for VEX Aware.",
};
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Breadcrumbs
          items={[
            ...
            { name: "Migration Tools", url: "/resources/migration-tools" },
          ]}
        />
        ...
        <article className="mt-8">
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Ready-to-use migration tools to accelerate your VEX Aware implementation.
            </p>
          </header>
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <h2>Overview</h2>
            <p>
              These migration tools are designed to help you quickly implement 
